...
export function ModrinthIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CurseForgeIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AcironIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="aciron-a" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="var(--color-accent)" />
          <stop offset="1" stopColor="var(--color-accent-hover)" />
        </linearGradient>
      </defs>
      <rect width="24" height="24" rx="6" fill="url(#aciron-a)" />
      <text
        x="12"
        y="17"
        textAnchor="middle"
