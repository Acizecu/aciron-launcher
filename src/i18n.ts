...
const EN: Record<string, string> = {
  ...
  "Обложка": "Cover",
  "Поставить OptiFine": "Install OptiFine",
  "Реклама": "Ad",
  "Ставим…": "Installing…",
  "Сборка «{name}» готова": "«{name}» is ready",
  "Свежая сборка с optifine.net, в папку модов":
    "Latest build from optifine.net, into the mods folder",
  ...
  "Флаги виртуальной машины при запуске, через пробел":
    "Extra JVM flags at launch (space-separated)",
  "Размер окна игры": "Game window size",
  "Когда полноэкранный режим выключен": "Used when fullscreen is off",
  "Полноэкранный режим": "Fullscreen",
  "Игра откроется на весь экран": "The game opens fullscreen",
  ...
  "Масштаб интерфейса. Работает и в развёрнутом окне, и в полноэкранном.":
    "Launcher scale — works maximized and fullscreen too",
  "Серверы Aciron в списке": "Aciron servers in the list",
  "Добавляет пять популярных серверов в список":
  ...
  "Не обновляться, пока идёт работа": "Do not update while you work",
  "Отключает и проверку, и установку. Пригодится, пока правите код.":
  ...
  "Короткий звук при наведении на кнопку": "A short sound when you hover a button",
  "Звук уведомлений": "Notification sound",
  "Звук при заявке в друзья и других уведомлениях":
  ...
  "Живая картинка за интерфейсом. Выбрать её можно в разделе «Темы».":
    "A living picture behind the interface. Pick one under Themes.",
  ...
  "Отчётов нет. Так выглядел бы отчёт о сбое, случись он сейчас":
  ...
  "Лаунчер запускается значком в трее, без окна. Чтобы открыть его, щёлкните по значку.":
  ...
  "Аккаунт Microsoft не совпадает с привязанным к Aciron. Войдите тем же аккаунтом или перепривяжите лицензию в настройках": "The Microsoft account does not match the one linked to Aciron. Sign in with the same account or relink the licence in settings",
  "Не удалось получить объявление": "Couldn't load the announcement",
  "Это не картинка": "This is not an image",
  "Это не файл": "This is not a file",
  "Картинка слишком большая": "The image is too large",
  "Своя версия": "Custom version",
  "Своё описание версии не читается": "Can't read the custom version description",
  "Нет своего клиента": "Custom client is missing",
  "Свой клиент": "Custom client",
  "Публикация логов в этой сборке не настроена": "Log sharing is not configured in this build",
  "Лог не найден. Он появляется после запуска игры и лежит в папке logs.": "Log not found. It appears after the game starts and is stored in the logs folder.",
  "Лог пуст, публиковать нечего": "The log is empty, nothing to share",
  "Не удалось подготовить соединение": "Couldn't prepare the connection",
  "Не удалось отправить лог": "Couldn't send the log",
  "Сервис логов ответил ошибкой": "The log service returned an error",
  "Непонятный ответ сервиса": "Unexpected service response",
  "Сервис не вернул ссылку": "The service did not return a link",
  "Minecraft сейчас не отвечает, попробуйте позже": "Minecraft is not responding right now, try again later",
  "Лицензия не привязана": "No licence is linked",
  "Mojang просит подождать, облик меняли слишком часто": "Mojang asks you to wait, the look was changed too often",
  "Minecraft ответил ошибкой": "Minecraft returned an error",
  "Файл скина повреждён": "The skin file is damaged",
  "Minecraft принимает только скины 64×64": "Minecraft only accepts 64×64 skins",
  "Не удалось забрать свой скин из Aciron": "Couldn't fetch your skin from Aciron",
  "Нет активного аккаунта": "No active account",
  "Aciron ID не выдал метку для проверки лицензии": "Aciron ID did not issue a licence check token",
  "Aciron ID не подтвердил лицензию": "Aciron ID did not confirm the licence",
  "Сервер не ответил вовремя": "Server did not respond in time",
  "Не удалось найти адрес сервера, проверьте интернет или DNS": "Couldn't find the server address, check your internet or DNS",
  "Не удалось соединиться с сервером": "Couldn't connect to the server",
  "Сервер прислал ответ, который не удалось прочитать": "The server sent a response that could not be read",
  "Сбой запроса": "Request failed",
  "Сайт OptiFine не отвечает": "The OptiFine site is not responding",
  "У OptiFine нет сборки под эту версию игры": "OptiFine has no build for this game version",
  "Не удалось разобрать страницу OptiFine": "Couldn't read the OptiFine page",
  "На странице OptiFine нет ссылки на файл": "The OptiFine page has no file link",
  "OptiFine отдал не файл, поставьте его вручную с optifine.net": "OptiFine did not return a file, install it manually from optifine.net",
  "OptiFine ставится только к Forge": "OptiFine can only be installed with Forge",
  "Не удалось получить рекламу": "Couldn't load the promo",
  "Реклама больше не действует": "The promo is no longer active",
  "Некорректная ссылка на сборку": "Invalid instance link",
  "Сборку не удалось скачать": "Couldn't download the instance",
  "По ссылке не сборка, сообщите владельцу сервера": "The link does not point to an instance, tell the server owner",
};
...
const TR: Record<string, string> = {
  ...
  "Обложка": "Kapak",
  "Поставить OptiFine": "OptiFine kur",
  "Реклама": "Reklam",
  "Ставим…": "Kuruluyor…",
  "Сборка «{name}» готова": "«{name}» hazır",
  "Свежая сборка с optifine.net, в папку модов":
    "optifine.net'ten en yeni sürüm, mods klasörüne",
  ...
  "Когда полноэкранный режим выключен": "Tam ekran modu kapalıysa kullanılır",
  "Полноэкранный режим": "Tam ekran",
  "Игра откроется на весь экран": "Oyun tam ekranda açılacak",
  ...
  "Серверы Aciron в списке": "Listede Aciron sunucuları",
  "Добавляет пять популярных серверов в список":
  ...
  "Не обновляться, пока идёт работа": "Çalışırken güncelleme yapma",
  "Отключает и проверку, и установку. Пригодится, пока правите код.":
  ...
  "Короткий звук при наведении на кнопку": "Düğmenin üzerine gelince hafif bir ses",
  ...
  "Живая картинка за интерфейсом. Выбрать её можно в разделе «Темы».":
    "Arayüzün ardında canlı bir görüntü. «Temalar» bölümünden seçebilirsiniz.",
  "Каждая тема приходит со своим. Выбранный здесь сохраняется вместе с темой и уезжает в её код.":
  ...
  "Аккаунт Microsoft не совпадает с привязанным к Aciron. Войдите тем же аккаунтом или перепривяжите лицензию в настройках": "Microsoft hesabı Aciron'a bağlı hesapla eşleşmiyor. Aynı hesapla giriş yapın veya lisansı ayarlardan yeniden bağlayın",
  "Не удалось получить объявление": "Duyuru yüklenemedi",
  "Это не картинка": "Bu bir görsel değil",
  "Это не файл": "Bu bir dosya değil",
  "Картинка слишком большая": "Görsel çok büyük",
  "Своя версия": "Özel sürüm",
  "Своё описание версии не читается": "Özel sürüm açıklaması okunamıyor",
  "Нет своего клиента": "Özel istemci yok",
  "Свой клиент": "Özel istemci",
  "Публикация логов в этой сборке не настроена": "Bu sürümde günlük paylaşımı yapılandırılmamış",
  "Лог не найден. Он появляется после запуска игры и лежит в папке logs.": "Günlük bulunamadı. Oyun başladıktan sonra oluşur ve logs klasöründe durur.",
  "Лог пуст, публиковать нечего": "Günlük boş, paylaşılacak bir şey yok",
  "Не удалось подготовить соединение": "Bağlantı hazırlanamadı",
  "Не удалось отправить лог": "Günlük gönderilemedi",
  "Сервис логов ответил ошибкой": "Günlük hizmeti hata döndürdü",
  "Непонятный ответ сервиса": "Beklenmeyen hizmet yanıtı",
  "Сервис не вернул ссылку": "Hizmet bir bağlantı döndürmedi",
  "Minecraft сейчас не отвечает, попробуйте позже": "Minecraft şu anda yanıt vermiyor, daha sonra tekrar deneyin",
  "Лицензия не привязана": "Bağlı lisans yok",
  "Mojang просит подождать, облик меняли слишком часто": "Mojang beklemenizi istiyor, görünüm çok sık değiştirildi",
  "Minecraft ответил ошибкой": "Minecraft hata döndürdü",
  "Файл скина повреждён": "Kaplama dosyası bozuk",
  "Minecraft принимает только скины 64×64": "Minecraft yalnızca 64×64 kaplamaları kabul eder",
  "Не удалось забрать свой скин из Aciron": "Kaplamanız Aciron'dan alınamadı",
  "Нет активного аккаунта": "Etkin hesap yok",
  "Aciron ID не выдал метку для проверки лицензии": "Aciron ID lisans doğrulama anahtarı vermedi",
  "Aciron ID не подтвердил лицензию": "Aciron ID lisansı onaylamadı",
  "Сервер не ответил вовремя": "Sunucu zamanında yanıt vermedi",
  "Не удалось найти адрес сервера, проверьте интернет или DNS": "Sunucu adresi bulunamadı, internetinizi veya DNS'i kontrol edin",
  "Не удалось соединиться с сервером": "Sunucuya bağlanılamadı",
  "Сервер прислал ответ, который не удалось прочитать": "Sunucu okunamayan bir yanıt gönderdi",
  "Сбой запроса": "İstek başarısız oldu",
  "Сайт OptiFine не отвечает": "OptiFine sitesi yanıt vermiyor",
  "У OptiFine нет сборки под эту версию игры": "OptiFine'ın bu oyun sürümü için derlemesi yok",
  "Не удалось разобрать страницу OptiFine": "OptiFine sayfası okunamadı",
  "На странице OptiFine нет ссылки на файл": "OptiFine sayfasında dosya bağlantısı yok",
  "OptiFine отдал не файл, поставьте его вручную с optifine.net": "OptiFine dosya döndürmedi, optifine.net üzerinden elle kurun",
  "OptiFine ставится только к Forge": "OptiFine yalnızca Forge ile kurulabilir",
  "Не удалось получить рекламу": "Reklam yüklenemedi",
  "Реклама больше не действует": "Reklam artık geçerli değil",
  "Некорректная ссылка на сборку": "Geçersiz derleme bağlantısı",
  "Сборку не удалось скачать": "Derleme indirilemedi",
  "По ссылке не сборка, сообщите владельцу сервера": "Bağlantı bir derlemeye gitmiyor, sunucu sahibine bildirin",
};;
...
function ruKeyOf(s: string): string | undefined {

  if (Object.prototype.hasOwnProperty.call(EN, s)) return s;
  if (!enToRu) enToRu = new Map(Object.entries(EN).map(([ru, en]) => [en, ru]));
  return enToRu.get(s);
}

function translateKnown(s: string): string | undefined {
  const ru = ruKeyOf(s);
...
export function ts(msg: string): string {
  ...
  const whole = translateKnown(clean);
  if (whole) return whole;

  const m = /:\s/.exec(clean);
  if (m && m.index > 0) {
    const head = translateKnown(clean.slice(0, m.index));
